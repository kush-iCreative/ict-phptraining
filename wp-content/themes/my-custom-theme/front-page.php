        ...
        <div class="container ">
            <div class="row">
                <div class="col-md-6  ">
                    <div class="box ">
                        <div class="img-box">
                            <img src="<?php the_field('offer_image'); ?>" alt="<?php the_field('offer_title'); ?>">
                        </div>
                        <div class="detail-box">
                            <h5>
                                  <h5><?php the_field('offer_title'); ?></h5>
                            </h5>
                            <h6>
                                <span><?php the_field('offer_discount') ?></span> Off
                            </h6>
                            <a href="">
                                <?php the_field('offer_button') ?><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.029 456.029" style="enable-background:new 0 0 456.029 456.029;" xml:space="preserve">
                                    <g>
                                        <g>
